// ignore_for_file: prefer_const_constructors, prefer_const_constructors_in_immutables, avoid_print, avoid_unnecessary_containers, unused_field, prefer_final_fields, use_build_context_synchronously, empty_statements, use_key_in_widget_constructors, unnecessary_new
  ...
  Future<void> checkForExistingSession() async {
    ...
    if (token != null) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => IFlutterBarcodeScanner()),
      );
    }
  }
